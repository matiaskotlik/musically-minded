...
export const PGRST_COULD_NOT_CONNECT_DB_URI = 'PGRST000';
export const PGRST_INTERNAL_DB_CONNECTION_ERROR = 'PGRST001';
export const PGRST_SCHEMA_CACHE_DB_CONNECTION_ERROR = 'PGRST002';
export const PGRST_POOL_CONNECTION_TIMEOUT = 'PGRST003';
export const PGRST_QUERY_STRING_PARSE_ERROR = 'PGRST100';
export const PGRST_FUNCTION_VERB_NOT_ALLOWED = 'PGRST101';
export const PGRST_INVALID_REQUEST_BODY = 'PGRST102';
export const PGRST_INVALID_RANGE_PAGINATION = 'PGRST103';
export const PGRST_INVALID_PUT_REQUEST = 'PGRST105';
export const PGRST_SCHEMA_NOT_IN_CONFIG = 'PGRST106';
export const PGRST_INVALID_CONTENT_TYPE = 'PGRST107';
export const PGRST_EMBEDDED_FILTER_MISSING_SELECT = 'PGRST108';
export const PGRST_LIMITED_UPDATE_DELETE_NO_UNIQUE_ORDER = 'PGRST109';
export const PGRST_LIMITED_UPDATE_DELETE_EXCEEDS_LIMIT = 'PGRST110';
export const PGRST_INVALID_RESPONSE_HEADERS = 'PGRST111';
export const PGRST_INVALID_STATUS_CODE = 'PGRST112';
export const PGRST_INVALID_UPSERT_WITH_LIMITS = 'PGRST114';
export const PGRST_UPSERT_PRIMARY_KEY_MISMATCH = 'PGRST115';
export const PGRST_SINGULAR_RESPONSE_ITEM_COUNT_MISMATCH = 'PGRST116';
export const PGRST_HTTP_VERB_NOT_SUPPORTED = 'PGRST117';
export const PGRST_ORDER_RELATED_TABLE_NO_RELATION = 'PGRST118';
export const PGRST_SPREAD_RELATED_TABLE_NO_RELATION = 'PGRST119';
export const PGRST_EMBEDDED_FILTER_ONLY_NULL_ALLOWED = 'PGRST120';
export const PGRST_RAISE_PARSING_ERROR = 'PGRST121';
export const PGRST_INVALID_PREFER_HEADER = 'PGRST122';
export const PGRST_STALE_FOREIGN_KEY = 'PGRST200';
export const PGRST_AMBIGUOUS_EMBEDDING = 'PGRST201';
export const PGRST_FUNCTION_NOT_FOUND = 'PGRST202';
export const PGRST_OVERLOADED_FUNCTION_REQUEST = 'PGRST203';
export const PGRST_COLUMN_NOT_FOUND = 'PGRST204';
export const PGRST_MISSING_JWT_SECRET = 'PGRST300';
export const PGRST_INVALID_JWT = 'PGRST301';
export const PGRST_AUTH_REQUIRED_ANON_ROLE_DISABLED = 'PGRST302';
